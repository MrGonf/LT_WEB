...
public class UserDaoImpl extends DBMySQLConnect implements IUserDAO {
	...
	public boolean signup(String email, String password, String username, String fullname, String phone) {
		String sql = "INSERT INTO users(username, password, email, fullname, phone, roleid, createDate) "
				+ "VALUES (?, ?, ?, ?, ?, ?, ?)";
	...
	public static void main(String[] args) {
		...
		// Thêm 1 user mẫu
		UserModel newUser = new UserModel(0, "Gonf", "123", "G@gmail.com", "MG", "", 1, "0123456789",
				new java.util.Date());
