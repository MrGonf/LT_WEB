...
public class UserModel implements Serializable {
	...
	public UserModel(String username, String password, String email, String fullname, int roleid, String phone,
			Date createDate) {
		super();
...
//================== Images =================//
	...
	public String toString() {
		return "UserModel [id=" + id + ", username=" + username + ", password=" + password + ", email=" + email
				+ ", fullname=" + fullname + ", roleid=" + roleid + ", phone=" + phone + ", createdDate=" + createDate
				+ ", images=" + images + "]";
	}
